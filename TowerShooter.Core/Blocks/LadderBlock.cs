...
{
    internal class LadderBlock : IGameBlock
    {
        Vector2 Position;
        ...
        public BlockType BlockType { get; set; } = BlockType.Ladder;
        ...
        public LadderBlock(int xPos, int yPos, ITowerShooter towerShooter)
        {
            ...
            _texture2D = _towerShooter.ContentManager.Load<Texture2D>("LadderBlock");
            UpdateRectangle();
        }
