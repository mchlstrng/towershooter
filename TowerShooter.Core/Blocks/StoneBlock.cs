...
{
    internal class StoneBlock : IGameBlock
    {
        Vector2 Position;
        ...
        public BlockType BlockType { get; set; } = BlockType.Stone;
        ...
        public StoneBlock(int xPos, int yPos, ITowerShooter towerShooter)
        {
            ...
            _texture2D = towerShooter.ContentManager.Load<Texture2D>("SolidBlock");
